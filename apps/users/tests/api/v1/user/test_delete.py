...
class TestUserDelete:
    ...
    def test_delete_non_admin_fail(self, auth_client, finance_user, customer_support_user):
    ...
    def test_delete_non_dashboard_user_fail(self, auth_client, admin_user, company_owner):
