...
def test_delete_without_authentication_fail(api_client, finance_user):
...
def test_delete_non_admin_fail(auth_client, finance_user, customer_support_user):
...
def test_delete_dashboard_user_success(auth_client, admin_user, finance_user):
...
def test_delete_non_dashboard_user_fail(auth_client, admin_user, company_owner):
...
def test_delete_unknown_user_fail(auth_client, admin_user):
