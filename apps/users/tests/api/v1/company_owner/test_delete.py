...
def test_delete_without_authentication_fail(api_client, company_owner):
...
def test_delete_as_company_owner_fail(auth_client, company_owner, company):
...
def test_delete_success(auth_client, admin_user, other_company_owner):
...
def test_delete_unknown_fail(auth_client, admin_user):
