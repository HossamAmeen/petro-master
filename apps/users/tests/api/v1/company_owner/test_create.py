...
class TestCompanyOwnerCreate:
    ...
    def test_create_without_authentication_fail(
        self, api_client, company_owner_payload_factory
    ):
    ...
    def test_create_as_company_owner_fail(
        self, auth_client, company_owner, company, company_owner_payload_factory
    ):
    ...
    def test_create_as_dashboard_success(
        self, auth_client, finance_user, company, company_owner_payload_factory
    ):
    ...
    def test_create_defaults_email_success(
        self, auth_client, admin_user, company_owner_payload_factory
    ):
        payload = company_owner_payload_factory()
        payload.pop("email")
    ...
    def test_create_without_company_id_fail(
        self, auth_client, admin_user, company_owner_payload_factory
    ):
        payload = company_owner_payload_factory()
    ...
    def test_create_with_foreign_company_branches_fail(
        self,
        auth_client,
        admin_user,
        company,
