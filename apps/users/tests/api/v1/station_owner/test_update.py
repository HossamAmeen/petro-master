...
def test_update_without_authentication_fail(api_client, station_owner):
...
def test_update_as_company_owner_fail(
    auth_client, company_owner, company, station_owner
):
...
def test_update_name_success(auth_client, admin_user, station_owner):
