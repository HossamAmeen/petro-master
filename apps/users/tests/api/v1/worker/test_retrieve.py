...
def test_retrieve_without_authentication_fail(api_client, station_worker):
...
def test_retrieve_success(auth_client, admin_user, station_worker, branch, station):
...
def test_update_name_success(auth_client, station_owner, station, station_worker):
...
def test_update_password_success(auth_client, admin_user, station_worker):
...
def test_update_password_without_confirm_fail(auth_client, admin_user, station_worker):
    response = auth_client(admin_user).patch(
        workers_detail_url(station_worker.id),
...
def test_update_password_mismatch_fail(auth_client, admin_user, station_worker):
    response = auth_client(admin_user).patch(
        workers_detail_url(station_worker.id),
...
def test_delete_as_company_owner_fail(
    auth_client, company_owner, company, station_worker
):
...
def test_delete_success(auth_client, admin_user, other_station_worker):
