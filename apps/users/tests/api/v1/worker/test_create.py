...
class TestWorkerCreate:
    ...
    def test_create_without_authentication_fail(
        self, api_client, worker_payload_factory
    ):
    ...
    def test_create_as_company_owner_fail(
        self, auth_client, company_owner, company, worker_payload_factory
    ):
    ...
    def test_create_as_station_owner_success(
        self, auth_client, station_owner, station, branch, worker_payload_factory
    ):
    ...
    def test_create_as_dashboard_success(
        self, auth_client, admin_user, branch, worker_payload_factory
    ):
        payload = worker_payload_factory()
        payload.pop("email")
    ...
    def test_create_station_admin_foreign_branch_fail(
        self,
        auth_client,
        station_owner,
        station,
    ...
    def test_create_duplicate_phone_fail(
        self, auth_client, admin_user, station_worker, worker_payload_factory
    ):
    ...
    def test_create_password_mismatch_fail(
        self, auth_client, admin_user, worker_payload_factory
    ):
