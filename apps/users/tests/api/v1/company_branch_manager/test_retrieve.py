...
class TestCompanyBranchManagerRetrieve:
    ...
    def test_retrieve_as_station_owner_fail(
        self, auth_client, station_owner, station, company_branch_manager
    ):
    ...
    def test_retrieve_includes_managed_branches_success(
        self, auth_client, admin_user, company_branch_manager, company, company_branch
    ):
    ...
    def test_retrieve_other_company_as_owner_fail(
        self, auth_client, company_owner, company, other_company_branch_manager
    ):
