...
from apps.stations.api.v1.views.car_operation_views import AddCarGasOperationAPIView
...
urlpatterns += [
    ...
    path(
        "add-car-gas-operation/",
        AddCarGasOperationAPIView.as_view(),
        name="add-car-gas-operation",
    ),
