...
class TestStationOperations:
    ...
    def test_operations_worker_sees_own_only_success(self,
        auth_client,
        station_worker,
    ...
    def test_operations_owner_sees_station_ops_not_other_station_success(self,
        auth_client,
        station_owner,
        station,
        gas_operation,
    ...
    def test_operations_branch_manager_scoped_success(self,
        auth_client,
        branch_manager,
        station,
        gas_operation,
    ...
    def test_operations_balances_split_by_service_type_success(self,
        auth_client,
        station_owner,
        station,
        gas_operation,
    ...
    def test_operations_filter_by_status_success(self,
    ...
    def test_operations_search_by_driver_name_success(self,
    ...
    def test_operations_diesel_counts_as_petrol_balance_success(self,
        auth_client,
        station_owner,
        station,
        diesel_service,
    ...
    def test_operations_empty_balances_success(self, auth_client, station_owner, station):
        response = auth_client(station_owner, station_id=station.id).get(
            operations_url(no_paginate="true")
        )
    ...
    def test_operations_filter_by_worker_and_service_success(self,
        auth_client,
        station_owner,
        station,
        gas_operation,
    ...
    def test_operations_search_by_code_success(self,
        auth_client, station_owner, station, gas_operation, car_operation_factory
    ):
    ...
    def test_operations_status_comma_filter_success(self,
        auth_client, station_owner, station, gas_operation, car_operation_factory
    ):
        done = car_operation_factory(status=CarOperation.OperationStatus.COMPLETED)
