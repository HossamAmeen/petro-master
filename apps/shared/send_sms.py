...
# Without a timeout a hung provider blocks forever instead of raising a
# retryable requests.Timeout.
...
def send_sms(message, receiver):
    ...
    response = requests.request("GET", url, timeout=SMS_TIMEOUT_SECONDS)
