...
class TestSignals:
    ...
    def test_create_notification_sends_fcm_with_user_tokens_success(self,
        mock_firebase_notifications, admin_user, notification_factory
    ):
    ...
    def test_create_notification_without_tokens_still_sends_empty_list_success(self,
        mock_firebase_notifications, admin_user, notification_factory
    ):
    ...
    def test_update_notification_does_not_resend_fcm_success(self,
        mock_firebase_notifications, admin_user, notification_factory
    ):
