...
class TestUpdate:
    ...
    def test_update_without_authentication_fail(self, api_client, admin_user, notification_factory):
    ...
    def test_update_marks_read_success(self, auth_client, admin_user, notification_factory):
    ...
    def test_update_ignores_title_and_type_success(self,
    ...
    def test_update_other_users_notification_fail(self,
    ...
    def test_update_unknown_notification_fail(self, auth_client, admin_user):
        response = auth_client(admin_user).patch(
    ...
    def test_update_decreases_dashboard_unread_count_success(self,
        auth_client, admin_user, notification_factory
    ):
        note = notification_factory(user=admin_user, is_read=False)
    ...
    def test_retrieve_method_not_allowed_fail(self,
        auth_client, admin_user, notification_factory
    ):
        note = notification_factory(user=admin_user)
    ...
    def test_delete_method_not_allowed_fail(self,
        auth_client, admin_user, notification_factory
    ):
        note = notification_factory(user=admin_user)
