...
class TestFcmManager:
    ...
    def test_send_fcm_message_sends_one_message_per_token_success(self,
    ...
    @patch("apps.notifications.fcm_manager.messaging.Message")
    @patch("apps.notifications.fcm_manager.messaging.Notification")
    def test_send_fcm_message_empty_tokens_success(self,
        mock_notification, mock_message, mock_send_each
    ):
    ...
    @patch("apps.notifications.fcm_manager.messaging.Message")
    @patch("apps.notifications.fcm_manager.messaging.Notification")
    def test_send_fcm_message_exception_returns_none_fail(self,
        mock_notification, mock_message, mock_send_each
    ):
