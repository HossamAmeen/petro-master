...
def test_list_payload_fields_success(auth_client, admin_user, notification_factory):
...
def test_list_newest_first_success(auth_client, admin_user, notification_factory):
...
def test_list_filter_is_read_success(auth_client, admin_user, notification_factory):
...
def test_list_filter_type_iexact_success(auth_client, admin_user, notification_factory):
...
def test_list_search_title_success(auth_client, admin_user, notification_factory):
...
def test_list_search_description_success(auth_client, admin_user, notification_factory):
...
def test_create_method_not_allowed_fail(auth_client, admin_user):
