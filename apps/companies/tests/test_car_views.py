...
class TestCarViewSetUpdateBalance:
    ...
    def test_subtract_balance_as_company_owner_success(
        ...
        data = {"amount": "25.00", "type": "subtract"}
    ...
    def test_add_balance_insufficient_fails(self):
        ...
        data = {"amount": "1500.00", "type": "add"}  # More than company balance (1000)
    ...
    def test_subtract_balance_insufficient_fails(self):
        ...
        data = {"amount": "200.00", "type": "subtract"}  # More than car balance (100)
    ...
    def test_update_balance_invalid_type(self):
        ...
        # Invalid type
        data = {"amount": "50.00", "type": "invalid"}
