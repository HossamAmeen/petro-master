...
class TestCompanyBranchDelete:


    def test_delete_without_authentication_fail(self, api_client, company_branch):
    ...
    def test_delete_branch_success(self, auth_client, admin_user, company_branch_factory):
    ...
    def test_delete_owned_branch_as_company_owner_success(self,
    ...
    def test_delete_other_company_branch_as_owner_fail(self,
    ...
    def test_delete_unmanaged_branch_as_branch_manager_fail(self,
    ...
    def test_delete_branch_with_related_records_fail(self,
        related_fixture,
        request,
        auth_client,
        admin_user,
    ...
    def test_delete_unknown_branch_fail(self, auth_client, admin_user):
