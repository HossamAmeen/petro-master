...
class TestCompanyBranchRetrieve:
    ...
    def test_retrieve_branch_with_related_counts_success(self,
        auth_client,
        admin_user,
        company_branch,
        company_car,
    ...
    def test_retrieve_owned_branch_as_company_owner_success(self,
    ...
    def test_retrieve_other_company_branch_as_owner_fail(self,
    ...
    def test_retrieve_unmanaged_branch_as_branch_manager_fail(self,
    ...
    def test_retrieve_managed_branch_as_branch_manager_success(self,
        auth_client, company_branch_manager, company, company_branch
    ):
        response = auth_client(company_branch_manager, company_id=company.id).get(
            branch_detail_url(company_branch.id)
        )
    ...
    def test_retrieve_any_branch_as_station_worker_success(self,
        auth_client, station_worker, station, other_company_branch
    ):
