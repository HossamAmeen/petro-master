...
class TestCarUpdate:
    ...
    def test_partial_update_without_authentication_fail(self, api_client, company_car):
    ...
    def test_partial_update_company_restricted_field_ignored_success(self,
        restricted_field,
        new_value,
        auth_client,
        company_owner,
    ...
    def test_partial_update_dashboard_balance_success(self,
        auth_client,
        admin_user,
        company_car,
    ):
    ...
    def test_full_update_car_success(self,
        auth_client,
        company_owner,
        company,
        company_car,
