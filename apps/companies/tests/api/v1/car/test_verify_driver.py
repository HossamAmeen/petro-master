...
def test_verify_driver_without_authentication_fail(
...
def test_verify_driver_get_not_allowed_fail(auth_client, station_worker, station):
...
def test_verify_driver_petrol_success(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_non_petrol_success(
    service_type,
    auth_client,
    station_worker,
    station,
...
def test_verify_driver_non_petrol_uses_full_balance_as_cost_success(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_petrol_with_branch_fees_success(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_petrol_capped_by_permitted_fuel_amount_success(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_petrol_exact_one_liter_balance_success(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_strips_codes_success(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_unknown_car_code_fail(
...
def test_verify_driver_inactive_company_fail(
    auth_client,
    station_worker,
    station,
    company,
...
def test_verify_driver_unknown_driver_code_fail(
...
def test_verify_driver_car_not_allowed_today_fail(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_empty_fuel_allowed_days_fail(
    auth_client,
    station_worker,
    station,
    company_driver,
...
def test_verify_driver_petrol_insufficient_balance_fail(
    balance,
    auth_client,
    station_worker,
    station,
...
def test_verify_driver_second_request_blocked_after_success_fail(
    auth_client,
    station_worker,
    station,
    company_driver,
