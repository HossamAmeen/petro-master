...
def test_update_balance_without_authentication_fail(api_client, company_car):
...
def test_add_balance_with_insufficient_parent_balance_fail(
    auth_client,
    company_owner,
    company,
    company_car,
...
def test_subtract_balance_with_insufficient_car_balance_fail(
    auth_client,
    company_owner,
    company,
    company_car,
...
def test_update_balance_for_blocked_car_fail(
    auth_client,
    company_owner,
    company,
    company_car,
...
def test_update_balance_with_invalid_payload_fail(
    payload,
    auth_client,
    company_owner,
    company,
