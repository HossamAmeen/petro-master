...
class TestCarCreate:
    ...
    def test_create_without_authentication_fail(self, api_client, car_payload_factory):
    ...
    def test_create_duplicate_car_code_fail(self,
        auth_client,
        company_owner,
        company,
        car_factory,
    ...
    def test_create_same_primary_and_backup_service_fail(self,
        auth_client,
        company_owner,
        company,
        service,
    ...
    def test_create_invalid_choice_fail(self,
        field,
        invalid_value,
        auth_client,
        company_owner,
