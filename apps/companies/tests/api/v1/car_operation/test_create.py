...
class TestCarOperationCreate:
    ...
    def test_create_without_authentication_fail(self, api_client, car_operation_payload_factory):
    ...
    def test_create_pending_as_admin_deducts_car_balance_success(self,
        auth_client,
        admin_user,
        company_car,
        company_driver,
    ...
    def test_create_completed_creates_transactions_and_notifications_success(self,
        auth_client,
        admin_user,
        company_owner,
    ...
    def test_create_with_company_fees_success(self,
        auth_client,
        admin_user,
        company_car,
        company_branch,
    ...
    def test_create_missing_required_fields_fail(self,
        payload,
        auth_client,
        admin_user,
        company_car,
