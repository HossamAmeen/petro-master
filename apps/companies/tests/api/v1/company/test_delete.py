...
def test_delete_without_authentication_fail(api_client, company):
...
def test_delete_company_success(auth_client, admin_user, company_factory):
...
def test_delete_unknown_company_fail(auth_client, admin_user):
