...
class TestStationLogin:
    ...
    def test_station_login_with_email_success(
    ...
    def test_station_login_with_phone_number_success(
    ...
    def test_station_worker_login_uses_branch_station_success(
        self, api_client, station_worker, station
    ):
    ...
    def test_station_login_missing_field_fail(
        self, api_client, station_owner, missing_field
    ):
