...
def test_station_login_with_email_success(role_fixture, request, api_client, station):
...
def test_station_login_with_phone_number_success(api_client, station_owner, station):
    response = _login(
...
def test_station_worker_login_uses_branch_station_success(
...
def test_station_login_missing_field_fail(api_client, station_owner, missing_field):
...
def test_station_login_wrong_password_fail(api_client, station_owner):
...
def test_station_login_unknown_identifier_fail(api_client):
...
def test_station_login_inactive_owner_fail(api_client, admin_user, station):
...
def test_station_login_inactive_worker_fail(api_client, admin_user, branch):
...
def test_station_login_wrong_role_fail(role_fixture, request, api_client):
    user = request.getfixturevalue(role_fixture)
...
def test_station_login_get_method_fail(api_client):
