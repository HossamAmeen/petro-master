...
class TestPasswordResetConfirm:
    ...
    def test_password_reset_confirm_get_valid_token_success(self, api_client):
        user = UserFactory()
    ...
    def test_password_reset_confirm_get_unknown_token_fail(self, api_client):
    ...
    def test_password_reset_confirm_get_expired_token_still_renders_form_success(
        self, api_client
    ):
        user = UserFactory()
        token = user.create_password_reset_token()
        user.reset_password_token_created_at = timezone.localtime() - timedelta(
            hours=25
        )
    ...
    def test_password_reset_confirm_post_valid_token_success(self, api_client):
        user = UserFactory()
    ...
    def test_password_reset_confirm_allows_login_with_new_password_success(
    ...
    def test_password_reset_confirm_cannot_reuse_token_fail(self, api_client):
        user = UserFactory()
        token = user.create_password_reset_token()
    ...
    def test_password_reset_confirm_unknown_token_fail(self, api_client):
        response = api_client.post(
    ...
    def test_password_reset_confirm_expired_token_fail(self, api_client):
        user = UserFactory()
        token = user.create_password_reset_token()
        user.reset_password_token_created_at = timezone.localtime() - timedelta(
            hours=24
    ...
    def test_password_reset_confirm_password_mismatch_fail(self, api_client):
        user = UserFactory()
        token = user.create_password_reset_token()
    ...
    def test_password_reset_confirm_password_too_short_fail(self, api_client):
        user = UserFactory()
        token = user.create_password_reset_token()
    ...
    def test_password_reset_confirm_missing_field_fail(self, api_client, missing_field):
        user = UserFactory()
        token = user.create_password_reset_token()
