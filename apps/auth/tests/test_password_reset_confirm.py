...
class TestPasswordResetConfirm:
    ...
    def test_password_reset_confirm_get_expired_token_still_renders_form_success(self, api_client):
        user = UserFactory()
        token = user.create_password_reset_token()
    ...
    def test_password_reset_confirm_allows_login_with_new_password_success(self, api_client, company_owner):
