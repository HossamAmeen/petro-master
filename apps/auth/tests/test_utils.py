...
def test_send_email_via_sendgrid_success(mock_client_cls, settings):
...
@patch("apps.auth.utils.SendGridAPIClient")
def test_send_email_via_sendgrid_client_error_fail(mock_client_cls, settings):
    settings.DEFAULT_FROM_EMAIL = "noreply@example.com"
    settings.SENDGRID_API_KEY = "sg-test-key"
...
@patch("apps.auth.utils.SendGridAPIClient")
def test_send_email_via_sendgrid_send_error_fail(mock_client_cls, settings):
    settings.DEFAULT_FROM_EMAIL = "noreply@example.com"
    settings.SENDGRID_API_KEY = "sg-test-key"
