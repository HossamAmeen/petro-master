...
def test_company_login_with_phone_number_success(api_client, company_owner, company):
...
def test_company_login_without_branches_success(api_client, company_owner, company):
...
def test_company_login_missing_field_fail(api_client, company_owner, missing_field):
...
def test_company_login_empty_identifier_fail(api_client, company_owner):
...
def test_company_login_wrong_password_fail(api_client, company_owner):
...
def test_company_login_unknown_identifier_fail(api_client):
...
def test_company_login_inactive_user_fail(api_client, admin_user, company):
...
def test_company_login_wrong_role_fail(role_fixture, request, api_client):
    user = request.getfixturevalue(role_fixture)
...
def test_company_login_get_method_fail(api_client):
