...
class TestCities:
    ...
    def test_list_cities_without_authentication_success(self, api_client, geo_data, other_city):
    ...
    def test_list_cities_as_authenticated_user_success(self, auth_client, admin_user, geo_data):
    ...
    def test_list_cities_filter_by_country_success(self,
